...
* - valid()
* Classes list:
* - AmazonReportList extends AmazonReportsCore
*/
...
class AmazonReportList extends AmazonReportsCore implements Iterator
{
    ...
    public function setTimeLimits($s = null, $e = null)
    {
        ...
        if (isset($this->options['AvailableFromDate']) && isset($this->options['AvailableToDate']) && $this->options['AvailableFromDate'] > $this->options['AvailableToDate']) {
