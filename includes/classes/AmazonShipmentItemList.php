...
* - valid()
* Classes list:
* - AmazonShipmentItemList extends AmazonInboundCore
*/
...
class AmazonShipmentItemList extends AmazonInboundCore implements Iterator
{
    ...
    public function setTimeLimits($lower = null, $upper = null)
    {
        try {
            ...
            if (isset($this->options['LastUpdatedAfter']) && isset($this->options['LastUpdatedBefore']) && $this->options['LastUpdatedAfter'] > $this->options['LastUpdatedBefore']) {
