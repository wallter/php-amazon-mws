...
* - valid()
* Classes list:
* - AmazonReportRequestList extends AmazonReportsCore
*/
...
class AmazonReportRequestList extends AmazonReportsCore implements Iterator
{
    ...
    public function setTimeLimits($s = null, $e = null)
    {
        ...
        if (isset($this->options['RequestedFromDate']) && isset($this->options['RequestedToDate']) && $this->options['RequestedFromDate'] > $this->options['RequestedToDate']) {
