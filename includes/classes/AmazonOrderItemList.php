...
* - valid()
* Classes list:
* - AmazonOrderItemList extends AmazonOrderCore
*/
...
class AmazonOrderItemList extends AmazonOrderCore implements Iterator
{
    ...
    public function fetchItems($r = true)
    {
        ...
        if (is_null($xml->AmazonOrderId)) {
            ...
            return false;
        } elseif (isset($this->options['AmazonOrderId']) && $this->options['AmazonOrderId'] && $this->options['AmazonOrderId'] != $xml->AmazonOrderId) {
