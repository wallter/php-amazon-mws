...
* - getProduct()
* Classes list:
* - AmazonProductsCore extends AmazonCore
*/
...
abstract class AmazonProductsCore extends AmazonCore
{
    ...
    public function __construct($s = null, $mock = false, $m = null, $config = null)
    {
        ...
        if (isset($this->store_config) && array_key_exists('marketplace_id', $this->store_config)) {
            $this->options['MarketplaceId'] = $this->store_config['marketplace_id'];
        } else {
    ...
    protected function parseXML($xml)
    {
        ...
        foreach ($xml->children() as $x) {
            ...
            } elseif ($x->getName() == 'GetProductCategoriesForSKUResult' || $x->getName() == 'GetProductCategoriesForASINResult') {
